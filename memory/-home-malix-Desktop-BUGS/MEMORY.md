...
- [0x Settler SC ($1M) — earned-null, RE-SOURCE](zerox-settler-immunefi-sc-surface-prioritize.md) — fortress confirmed + P-03 timebox executed (10 verdicts, all null); CrossChainReceiverFactory v1 deployed/at-rest but griefing fixed pre-deploy; **v2 unreleased (4 bugs, 78645) = standing reopen trigger on deploy**
