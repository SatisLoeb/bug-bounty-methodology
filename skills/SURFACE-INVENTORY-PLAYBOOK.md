...
- It is **not** the coverage-ledger (that runs at the END, before a fortress/null verdict, on in-scope FILES). Both exist; they bracket the engagement. Surface-inventory opens it, coverage-ledger closes it.
...
- **No "engagement complete / fortress" verdict while any IN-SCOPE row is UNAUDITED** (same gate spirit as the coverage-ledger; adjacent UNAUDITED rows are allowed to remain but must be listed).

## RELATIONSHIP TO OTHER PIECES
- `COVERAGE-LEDGER-PLAYBOOK.md` — the END-of-engagement file-level completeness gate (SC files before fortress/null). Surface-inventory is the START-of-engagement surface-level map. Both mandatory, they bracket the engagement.
